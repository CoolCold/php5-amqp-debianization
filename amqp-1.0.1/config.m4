dnl $Id: config.m4 323845 2012-03-02 21:23:25Z pdezwart $
...
if test "$PHP_AMQP" != "no"; then
	...
	AMQP_SOURCES="amqp.c amqp_exchange.c amqp_queue.c amqp_connection.c amqp_channel.c amqp_envelope.c"
